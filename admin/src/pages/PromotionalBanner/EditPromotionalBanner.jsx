...
function EditPromotionalBanner() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const { data } = await axios.get(`https://api.blueace.co.in/api/v1/get-single-promotional-banner/${id}`)
                const res = data.data;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.blueace.co.in/api/v1/update-promotional-banner/${id}`, payload, {
                headers: {
