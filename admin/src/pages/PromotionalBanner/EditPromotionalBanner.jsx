...
function EditPromotionalBanner() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const { data } = await axios.get(`http://localhost:7000/api/v1/get-single-promotional-banner/${id}`)
                const res = data.data;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`http://localhost:7000/api/v1/update-promotional-banner/${id}`, payload, {
                headers: {
