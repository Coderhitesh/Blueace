...
function EditServices() {
    ...
    const handleFetchMainCategory = async () => {
        try {
            const res = await axios.get('http://localhost:7000/api/v1/get-all-service-main-category');
    ...
    const handleFetchSubCategory = async (categoryId) => {
        try {
            const res = await axios.get(`http://localhost:7000/api/v1/get-all-service-category?mainCategoryId=${categoryId}`);
