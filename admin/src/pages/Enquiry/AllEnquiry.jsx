...
function AllEnquiry() {
    ...
    const fetchFAQData = async () => {
        setLoading(true);
        try {
            const res = await axios.get('https://api.blueace.co.in/api/v1/get-all-contact')
            if (res.data.success) {
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://api.blueace.co.in/api/v1/delete-contact/${id}`);
