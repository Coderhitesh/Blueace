...
function EditFAQBanner() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const { data } = await axios.get(`https://api.blueace.co.in/api/v1/get-single-faq-banner/${id}`)
                const res = data.data;
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.blueace.co.in/api/v1/update-faq-banner/${id}`, payload, {
                headers: {
