...
function AllFAQBanner() {
    ...
    const handleFetchData = async () => {
        setLoading(true);
        try {
            const response = await axios.get('https://api.blueace.co.in/api/v1/get-all-faq-banner');
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://api.blueace.co.in/api/v1/delete-faq-banner/${id}`);
            if (response.data.success) {
