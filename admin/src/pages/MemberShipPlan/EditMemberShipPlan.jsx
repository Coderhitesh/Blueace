...
function EditMemberShipPlan() {
    ...
    const fetchExistingData = async () => {
        try {
            const res = await axios.get(`http://localhost:7000/api/v1/get-single-membership-plan/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`http://localhost:7000/api/v1/update-membership-plan/${id}`, membershipData);
